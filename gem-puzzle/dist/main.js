...
function createBoard() {
  ...
  for (let i = 0; i < size * size; i++) {
    ...
    frame.append(tile);
    const left = i % size; //было 4
    const top = (i - left) / size; //было 4
